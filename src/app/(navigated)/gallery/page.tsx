...
export default function GalleryPage() {
  ...
  return <div className="w-full h-full flex flex-col gap-16 px-8 items-center">
    <h1 className="w-full text-center font-bold text-2xl">...님의 작품을 소개합니다.</h1>
    {data.map((_, index) => <Card key={index} imagePath="/dino.png" title='...' description="..." />)}
    <div ref={bottomRef} />
  </div>;
}